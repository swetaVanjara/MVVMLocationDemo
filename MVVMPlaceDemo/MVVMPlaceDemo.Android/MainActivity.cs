...
using MVVMPlaceDemo.Droid.Services;
using Xamarin.Forms;
using MVVMPlaceDemo.Models;

namespace MVVMPlaceDemo.Droid
{
    [Activity(Label = "MVVMPlaceDemo", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation | ConfigChanges.UiMode | ConfigChanges.ScreenLayout | ConfigChanges.SmallestScreenSize)]
